...
formula_teen = "cwealth_teen ~ moscho_sib + moage + gtatole*full + chbirtho + byear + male"
formula_ya = "cwealth_ya ~moscho_sib + moage + gtatole*full + chbirtho + byear + male + eduyr + rural_ya"  # + children_ya + formal_ya
formula_ea = "cwealth_ea ~ moscho_sib + moage + gtatole*full + chbirtho + byear + male + eduyr + rural_ea + formal_ea" #  + children_ea
