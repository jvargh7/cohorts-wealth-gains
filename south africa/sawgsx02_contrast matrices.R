...
contrast_matrix_bmi_ya[2,c(2,11)] <- 1 # wealth_child x male
contrast_matrix_bmi_ya[3,c(4)] <- 1 # cwealth_teen x female
contrast_matrix_bmi_ya[4,c(4,12)] <- 1 # cwealth_teen x male
contrast_matrix_bmi_ya[5,c(5)] <- 1 # cwealth_ya x female
contrast_matrix_bmi_ya[6,c(5,13)] <- 1 # cwealth_ya x male
