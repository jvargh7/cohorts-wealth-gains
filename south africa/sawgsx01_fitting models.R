...
formula_bmi_ya = "bmi_ya ~ wealth_child*male + cwealth_teen*male + cwealth_ya*male + moscho + moage + chbirtho + black + eduyr" 
formula_srq_ea = "srq_ea ~ wealth_child*male + cwealth_teen*male + cwealth_ya*male + cwealth_ea*male + moscho + moage + chbirtho + black + eduyr + children_ea + formal_ea + married_ea"
formula_ravens_ea = "ravens_ea ~ wealth_child*male + cwealth_teen*male + cwealth_ya*male + cwealth_ea*male + moscho + moage + chbirtho + black + eduyr + children_ea + formal_ea + married_ea"
formula_happiness_ea = "happiness_ea ~ wealth_child*male + cwealth_teen*male + cwealth_ya*male + cwealth_ea*male + moscho + moage + chbirtho + black + eduyr + children_ea + formal_ea + married_ea"
